...
<a href="/school/quiz_create" class="btn">Créer un nouveau quiz</a>
        ...
        <tbody>
            <?php foreach ($quizzes as $quiz): ?>
                <tr>
                    ...
                    <td>
                        <a href="/school/quiz_edit?id=<?= urlencode($quiz['id']) ?>">Modifier</a> |
                        <a href="/school/quiz_result?id=<?= urlencode($quiz['id']) ?>">Résultats</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
